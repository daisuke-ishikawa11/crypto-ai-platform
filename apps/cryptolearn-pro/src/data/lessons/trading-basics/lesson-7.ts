...
export const lesson7: Lesson = {
  ...
  content: {
    sections: [
      ...
      {
        type: 'tip',
        content: `<strong>ボリンジャーバンド活用のコツ</strong>
1. <strong>バンドの状態確認</strong>:
   - スクイーズ → ブレイクアウト戦略
   - エクスパンション → トレンドフォロー戦略
   - 時間軸別でのバンド状態比較
2. <strong>他指標との組み合わせ</strong>:
   - RSI：バンドタッチ時の買われすぎ・売られすぎ確認
   - MACD：トレンドの強さと方向性確認
   - 出来高：ブレイクアウトの信頼性確認
3. <strong>パラメーター調整</strong>: 市場特性に応じた期間・標準偏差の最適化！`
      },
      {
        type: 'text',
        content: `
      ...
      {
        type: 'warning',
        content: `<strong>ボリンジャーバンド使用時の注意点</strong>
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">1. 強いトレンド中の逆張りリスク</h3>
<strong>問題</strong>: バンドタッチでの逆張りが連続失敗
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>バンドウォーク発生時は逆張り禁止</li>
<li>トレンドの強さを事前確認(ADX等)</li>
<li>損切りルールの厳格な遵守</li>
</ul>
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">2. スクイーズ中の早期エントリー</h3>
<strong>問題</strong>: ブレイクアウト前の予想取引での損失
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>明確なバンドブレイクまで待機</li>
<li>出来高による確認を必須とする</li>
<li>ポジションサイズの適切な管理</li>
</ul>
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">3. パラメーター設定の市場適合性</h3>
<strong>問題</strong>: 標準設定が全ての相場に適さない
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>市場特性に応じた期間調整</li>
<li>標準偏差倍率の最適化</li>
...
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">4. 単独使用の限界</h3>
<strong>重要</strong>: ボリンジャーバンドは他の分析と組み合わせる
<strong>推奨組み合わせ</strong>: RSI、MACD、出来高、サポレジ
<strong>避けるべき</strong>: バンドシグナルのみでの大きなポジション
<strong>成功の秘訣</strong>: 相場環境を正確に把握し、適切な戦略を選択することが最も重要です。`
      },
      ],
    keyPoints: [
