...
export const lesson8: Lesson = {
  ...
  content: {
    sections: [
      ...
      {
        type: 'warning',
        content: `<strong>一目均衡表使用時の注意点</strong>
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">1. 複雑性による混乱</h3>
<strong>問題</strong>: 5つの要素が多すぎて判断に迷う
<strong>対策</strong>:
...
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">2. 急激な市場変動への対応</h3>
<strong>問題</strong>: 大きなニュースによる急変動で指標が機能しない
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>ファンダメンタル分析との併用</li>
<li>ストップロス設定の徹底</li>
<li>ポジションサイズの適切な管理</li>
</ul>
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">3. レンジ相場での効果限定</h3>
<strong>問題</strong>: 横ばい相場では多くのだましシグナル
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>明確なトレンド発生まで待機</li>
<li>雲の厚さと形状を重視</li>
<li>他のレンジ向け指標と組み合わせ</li>
</ul>
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">4. パラメーター固定の限界</h3>
<strong>問題</strong>: 9-26-52の設定が全市場に最適とは限らない
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>市場特性に応じた微調整検討</li>
<li>バックテストでの検証</li>
...
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">5. 学習コストの高さ</h3>
<strong>重要</strong>: 一目均衡表は習得に時間がかかる
<strong>推奨アプローチ</strong>: 基本概念から段階的に学習
<strong>避けるべき</strong>: 不完全な理解での実取引
<strong>成功の秘訣</strong>: 一目均衡表は強力ですが、総合的な理解と経験の蓄積が不可欠です。`
      },
      ],
    keyPoints: [
