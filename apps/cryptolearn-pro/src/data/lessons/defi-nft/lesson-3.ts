...
<div style="background: #e9ecef; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
  ...
  <div style="background: white; padding: 15px; border-radius: 8px;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; font-size: 13px;">
      ...
      {
        type: 'warning',
        content: `<strong>流動性提供・イールドファーミング時の重要な注意点</strong>

<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">1. 高利回りの罠</h3>
<strong>問題</strong>: 年利100%超の異常に高い利回りへの過度な期待
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>高利回りには必ず高リスクが伴う理解</li>
<li>プロトコルの持続可能性検証</li>
<li>投資額は総資産の一部に限定</li>
<li>短期間での撤退準備</li>
</ul>

<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">2. 一時的損失の軽視</h3>
<strong>問題</strong>: 手数料収入に注目し、一時的損失を軽視
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>一時的損失の仕組み完全理解</li>
<li>価格変動シナリオでの損益計算</li>
<li>相関の高い資産ペア選択</li>
<li>定期的な損益確認・戦略見直し</li>
</ul>

<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">3. 複雑すぎる戦略</h3>
<strong>問題</strong>: 理解不十分な複雑戦略での大金投入
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>理解できる範囲での投資</li>
<li>段階的な戦略拡張</li>
<li>各プロトコルリスクの個別評価</li>
<li>シンプル戦略から開始</li>
</ul>

<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">4. 税務・記録の軽視</h3>
<strong>問題</strong>: 複雑な取引の記録不備・税務処理誤り
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>全取引の詳細記録保持</li>
<li>専門的な税務ツール活用</li>
...
<h3 style="color: #374151; margin: 1.5rem 0 0.75rem 0;">5. セキュリティ対策不足</h3>
<strong>問題</strong>: ウォレットセキュリティ・プロトコル選択の甘さ
<strong>対策</strong>:
<ul style="margin: 1rem 0; padding-left: 1.5rem;">
<li>ハードウェアウォレット使用</li>
<li>複数監査済みプロトコルのみ利用</li>
<li>投資額分散・集中投資回避</li>
<li>緊急時撤退計画の準備</li>
</ul>

<strong>最重要</strong>: イールドファーミングは高収益の可能性がありますが、複数の新しいリスクが存在します。十分な理解と慎重なリスク管理が成功の鍵です。段階的アプローチで経験を積み、常に学習を続けることが長期的成功に不可欠です。`
      },
      ],
    keyPoints: [
