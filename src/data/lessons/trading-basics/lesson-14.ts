...
ADX(Average Directional Index)は、J.ウェルズ・ワイルダーによって開発された、トレンドの強さを測定する指標です。価格の方向性ではなく、トレンドの強度に焦点を当てており、トレンド相場とレンジ相場の判別、そしてトレンドの継続性を評価するために使用されます。
ADXシステムの構成要素
3つの指標から構成
