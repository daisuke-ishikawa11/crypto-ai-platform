...
CCI(Commodity Channel Index)は、ドナルド・ランバートが1980年に開発したテクニカル指標で、価格が統計的な平均からどれだけ乖離しているかを測定します。元々は商品(コモディティ)のサイクリカルな動きを分析するために作られましたが、現在では株式、FX、暗号通貨など幅広い市場で活用されています。
基本的な計算方法
計算式
