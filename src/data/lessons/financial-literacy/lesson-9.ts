...
- 専門的アドバイスの重要性`
    ...
    keyPoints: [
      '投資倫理とコンプライアンスの基本概念と重要性の理解',
      '実践的な活用方法の習得',
      'リスク管理と注意点の把握',
      '継続的な学習の必要性',
      '市場動向への適応能力'
    ],
    summary: 'このレッスンでは投資倫理とコンプライアンスについて包括的に学習しました。基本概念から実践的な活用方法まで、体系的に理解することで、より効果的な投資戦略の構築が可能になります。常にリスク管理を意識し、継続的な学習を心がけることが成功の鍵です。',
  },
