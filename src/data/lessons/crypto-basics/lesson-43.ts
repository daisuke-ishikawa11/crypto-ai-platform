...
export const lesson43: Lesson = {
  ...
  content: {
    sections: [
      {
        type: 'text',
        title: '暗号通貨とマクロ経済の関係性',
        content: `
          暗号通貨市場は当初独立性を保っていましたが、機関投資家参入により伝統的金融市場との相関が強まっています。
          ...
          **機関化期（2021-現在）:**
          ...
          現在の状況:
          - S&P 500との相関: 0.6-0.8
          - NASDAQ相関: 0.7-0.9（特に高）
          - ゴールド相関: 0.3-0.5
          - 新興国株式相関: 0.5-0.7

          機関投資家参入:
          - MicroStrategy: $4B+ Bitcoin投資
          - Tesla: $1.5B Bitcoin購入（後に一部売却）
          - El Salvador: Bitcoin法定通貨採用
          - ETF承認: 2024年Bitcoin ETF承認
          \`\`\`
      ...
      {
        type: 'text',
        title: '中央銀行デジタル通貨（CBDC）の影響',
        content: `
          CBDC の開発・導入は暗号通貨エコシステムに重大な影響を与える可能性があります。
          ...
          **主要国の進捗状況:**
          \`\`\`
          運用段階:
          - バハマ: Sand Dollar（2020年～）
          - 中国: デジタル人民元e-CNY（パイロット拡大中）
          - ナイジェリア: eNaira（2021年～）
      ...
      },
      {
        ...
        title: '経済サイクルと投資戦略',
        content: `
          マクロ経済環境の変化に応じた暗号通貨投資戦略の調整が重要になっています。

          **経済サイクルと暗号通貨の関係:**

          **景気サイクル別パフォーマンス:**
          \`\`\`
          拡張期（Recovery/Expansion）:
          特徴:
          - GDP成長率上昇
          - 雇用改善・消費増加
          - 企業収益向上
