...
export const lesson12: Lesson = {
  ...
  content: {
    sections: [
      {
        ...
        title: 'アルトコインとは',
        content: `
          アルトコイン（Altcoin）は「Alternative Coin」の略で、ビットコイン以外の全ての暗号通貨を指します。
          
          **アルトコインの特徴：**
          - **多様性**: 異なる技術や目的で開発
          - **革新性**: 新しい機能や改良点を提供
          - **専門性**: 特定の用途や業界に特化
          - **実験性**: 新しいコンセンサスアルゴリズムや技術の実験場
          - **競争性**: ビットコインの改良版や競合を目指す
        `
      },
      {
        type: 'text',
        ...
        content: `
          ...
          **1. プラットフォーム系（2025年8月時点）**
          - Ethereum (ETH): スマートコントラクトプラットフォーム（$4,692、DeFi TVL 60%）
          - Binance Smart Chain (BNB): 高速・低コスト
          - Cardano (ADA): 学術研究ベース（$0.60、週間+17.88%）
          - Solana (SOL): 高速処理能力（$198-202、時価総額約1,070億ドル、週間+21.6%）
          
          **2. 決済系**
          - Litecoin (LTC): ビットコインの軽量版
          - Ripple (XRP): 国際送金に特化
          - Stellar (XLM): 金融包摂を目的
    ...
    keyPoints: [
      'アルトコインはビットコイン以外の全ての暗号通貨',
      '決済、プラットフォーム、プライバシーなど目的別に分類',
      '技術革新と改良点を提供する実験的性格',
      'ボラティリティが高く、投資リスクも高い',
      '十分な調査と理解が投資成功の鍵'
    ],
    summary: 'アルトコインは多様な目的と技術を持つビットコイン以外の暗号通貨です。プラットフォーム系、決済系、プライバシー系など様々なカテゴリがあり、それぞれ異なる価値提案を持っています。投資には技術的理解と市場分析が重要です。',
    practicalExamples: [
      'Solana (SOL): 2025年8月$198-202、月間成長+36%、時価総額6位',
      'Cardano (ADA): 2025年予測$0.56-1.81、週間成長+17.88%',
      'Polkadot (DOT): 2025年予測$4.01-13.91、月間成長+122%',
      'Avalanche (AVAX): 2025年予測$17.50-91.10、月間成長+75%'
    ],
    warningNotes: [
      'アルトコインはビットコインより価格変動が激しい',
      '詐欺プロジェクトや「ラグプル」のリスクが存在',
      '流動性が低い銘柄は売却が困難な場合',
      '規制の変化で特定カテゴリが大きく影響を受ける',
      '技術的な問題で価値が急激に下落する可能性'
    ]
  },
  quiz: [
    {
