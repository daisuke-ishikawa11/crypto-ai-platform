...
export const lesson17: Lesson = {
  ...
  content: {
    sections: [
      {
        ...
        title: 'DeFiとは何か',
        content: `
          分散型金融（DeFi：Decentralized Finance）は、ブロックチェーン技術を基盤とした金融システムです。2025年現在、市場規模は1,530億ドルに達し、史上最高値を更新しています。
    ...
    practicalExamples: [
      'DeFi市場規模: 1,530億ドル史上最高値（2025年8月）、Ethereum が60%を占める',
      'Lido・Aave: 各340億ドルのTVL、リキッドステーキング630億ドル規模',
      'イールドファーミング: ステーブルコイン最大25%APY（2025年8月）',
      'クロスチェーン成長: Solana 120億ドル（+23%）、Avalanche +33%成長'
    ],
    warningNotes: [
